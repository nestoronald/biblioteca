<?php
	...
	*******************************************/
	...
	function formCategoryShow($idcategory,$idSubcategory=0){
		...
		$respuesta->script('
						$("#type_material").change(function(){
                            if ($(this).val()!="999"){
                                sel = $(this).val();
                                xajax_formPonenciasShow(0,0,xajax.getFormValues("frm_type"));
                            }else{
	...
	function formPonenciasShow($iddata=0,$idSubcategory=0,$form_1=""){
		$objResponse = new xajaxResponse();
	    ...
	    $html='<h2 class="txt-azul">'.$tituloGeneral.'</h2>
		   ...
		   if (isset($_SESSION["edit"])) {
			    ...
			    <div class="controls fright">';
			    if ($iddata>1) {
			    	$html .= '<a href="#" title="Primer Registro" class="btn btn-mini" onclick="xajax_editBook(1,1); return false;">
			    	<span class="inline ui-icon ui-icon-seek-first"></span>Primero
			     	</a>
			     	<a href="#" title="Anterior registro" class="btn btn-mini" onclick="xajax_editBook('.($iddata-1).',1); return false;">
			    	<span class="inline ui-icon ui-icon-seek-prev"></span>Anterior
			     	</a>'
			     	;
			    }
			    if ($iddata<$result_book["Count"]) {
			    	$html .= ' <a href="#" title="Siguiente registro" class="btn btn-mini" onclick="xajax_editBook('.($iddata+1).',1); return false;">
	    ...
	    $input_array = array("TypeMatBib","title","state","FxIng","Description","NoteGeneral","MatEntidad");
